package com.sarthak.facefilter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final ArrayList<Pair<Integer, Integer>> Filters = new ArrayList<>(Arrays.asList(
            new Pair<>(R.raw.glasses1,R.drawable.devil),
            new Pair<>(R.raw.glasses1,R.drawable.cat),
            new Pair<>(R.raw.glasses1,R.drawable.hat),
            new Pair<>(R.drawable.transparent,R.drawable.avenger),
            new Pair<>(R.raw.glasses1,R.drawable.pinky),
            new Pair<>(R.raw.glasses1,R.drawable.transparent),
            new Pair<>(R.raw.glasses1, R.drawable.moustache),
            new Pair<>(R.raw.glasses3, R.drawable.dog)));
